...
module.exports = {
  ...
  db: {
    ...
    options: {
      user: '',
      pass: '',
      useNewUrlParser: true, //fix source: https://github.com/typeorm/mongo-typescript-example/issues/1#issuecomment-403373198
      useCreateIndex: true, //https://github.com/Automattic/mongoose/issues/6922#issue-354147871
    },
